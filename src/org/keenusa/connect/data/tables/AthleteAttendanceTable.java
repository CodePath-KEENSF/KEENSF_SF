...
public class AthleteAttendanceTable {
	...
	public static String getCreateSQL() {
		return "CREATE TABLE " + TABLE_NAME + " (" + "_id INTEGER PRIMARY KEY AUTOINCREMENT, " + REMOTE_ID_COL_NAME + " NUMBER NOT NULL UNIQUE, "
				+ REMOTE_CREATED_COL_NAME + " NUMBER NOT NULL DEFAULT 0, " + REMOTE_UPDATED_COL_NAME + " NUMBER NOT NULL DEFAULT 0, "
				+ SESSION_ID_COL_NAME + " NUMBER, " + ATHLETE_ID_COL_NAME + " NUMBER, " + ATTENDANCE_VALUE_COL_NAME + " TEXT);";
	}
