...
public class CoachCheckInAdapterAllAtt extends ArrayAdapter<CoachAttendance> {
	...
	public CoachCheckInAdapterAllAtt(Context context, List<CoachAttendance> objects) {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			viewHolder.tvCoachRegistered = (TextView) convertView.findViewById(R.id.tvCoachRegistered);
			...
			viewHolder.tvCoachNCNS = (TextView) convertView.findViewById(R.id.tvCoachNCNS);
		...
		if (coachAttendance != null) {
			...
			viewHolder.tvCoachRegistered.setTextColor(getContext().getResources().getColor(android.R.color.darker_gray));
			...
			if (attendanceValue == CoachAttendance.AttendanceValue.REGISTERED) {
				viewHolder.tvCoachRegistered.setTextColor(getContext().getResources().getColor(android.R.color.holo_blue_dark));
				...
				viewHolder.tvCoachCancelled.setTextColor(getContext().getResources().getColor(android.R.color.holo_red_dark));
			} else if (attendanceValue == CoachAttendance.AttendanceValue.NO_CALL_NO_SHOW) {
				viewHolder.tvCoachNCNS.setTextColor(getContext().getResources().getColor(android.R.color.holo_red_dark));
			}
		}
	...
	public void setOnClickListeners(View convertView, ViewHolder viewHolder) {
		...
		viewHolder.tvCoachRegistered.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				tvCoachRegistered.setTextColor(getContext().getResources().getColor(android.R.color.holo_blue_dark));
		...
		viewHolder.tvCoachCancelled.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				tvCoachCancelled.setTextColor(getContext().getResources().getColor(android.R.color.holo_red_dark));
		...
		viewHolder.tvCoachNCNS.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				...
				tvCoachNCNS.setTextColor(getContext().getResources().getColor(android.R.color.holo_red_dark));
