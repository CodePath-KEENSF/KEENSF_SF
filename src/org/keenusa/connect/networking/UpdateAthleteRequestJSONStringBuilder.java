...
public class UpdateAthleteRequestJSONStringBuilder {
	...
	public static String buildRequestJSONString(Context context, Athlete athlete) {
		if (athlete != null) {
	...
	private static JSONObject getRequestFieldListValue(Athlete athlete) {
		JSONObject athleteJSON = new JSONObject();
		try {
			if (athlete.getPhone() != null) {
				athleteJSON.put("homePhone", athlete.getPhone());
			}
			if (athlete.getEmail() != null) {
				athleteJSON.put("email", athlete.getEmail());
			}
			if (athlete.getPrimaryParent() != null && athlete.getPrimaryParent().getCellPhone() != null) {
				athleteJSON.put("parentGuardianCellPhone", athlete.getPrimaryParent().getCellPhone());
			}
			if (athlete.getPrimaryParent() != null && athlete.getPrimaryParent().getPhone() != null) {
				athleteJSON.put("parentGuardianHomePhone", athlete.getPrimaryParent().getPhone());
			}
			if (athlete.getPrimaryParent() != null && athlete.getPrimaryParent().getEmail() != null) {
				athleteJSON.put("parentGuardianEmailAddress", athlete.getPrimaryParent().getEmail());
			}
