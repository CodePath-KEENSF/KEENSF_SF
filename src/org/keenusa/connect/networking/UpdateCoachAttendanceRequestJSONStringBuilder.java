...
public class UpdateCoachAttendanceRequestJSONStringBuilder {

	public static final String LOG_TAG_CLASS = UpdateCoachAttendanceRequestJSONStringBuilder.class.getSimpleName();
	...
	public static final String ATHLETE_ATTENDANCE_TABLE_NAME_VALUE = "contacts_days_attendance";
	...
	public static String buildRequestJSONString(Context context, CoachAttendance coachAttendance) {
		if (coachAttendance != null) {
			...
			try {
				...
				jsonParams.put(RECORD_ID_PARAMETER_KEY, String.valueOf(coachAttendance.getRemoteId()));
	...
	private static JSONObject getRequestFieldListValue(CoachAttendance coachAttendance) {
		...
		try {
			if (coachAttendance.getAttendanceValue() != null) {
