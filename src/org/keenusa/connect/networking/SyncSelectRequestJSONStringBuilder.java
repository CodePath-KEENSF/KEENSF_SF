...
public class SyncSelectRequestJSONStringBuilder {

	public static final String PAGE_SIZE = "2000";

	public static final String LOG_TAG_CLASS = SyncSelectRequestJSONStringBuilder.class.getSimpleName();
	...
	public static String buildRequestJSONString(Context context, SyncKeenCivicoreClient.APIRequestCode apiRequestCode, int page) {
	...
	private static String getRequestTableNameFieldValue(SyncKeenCivicoreClient.APIRequestCode apiRequestCode) {
	...
	private static JSONArray getRequestFieldListValue(SyncKeenCivicoreClient.APIRequestCode apiRequestCode) {
